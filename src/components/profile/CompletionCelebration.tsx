      ...
      <div className="max-w-2xl mx-auto text-center animate-fade-in">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            🎉 Congratulations! Your profile setup is complete and you're ready to explore amazing projects.
          </p>
        </div>
        ...
        <div className="bg-card/80 backdrop-blur-sm usergy-shadow-strong rounded-3xl p-8 mb-8 border border-border/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-gradient-to-br from-success/10 to-success/20 rounded-xl">
              ...
              <div className="text-sm text-muted-foreground">Profile Setup</div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Welcome to where innovation meets insight, {profileData.full_name || 'Explorer'}!
          </p>
        </div>
      </div>
    </div>
